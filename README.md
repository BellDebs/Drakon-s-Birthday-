...
<audio id="bgMusic" loop>
  <source src="https://archive.org/download/sample-mp3-2/sample-2.mp3" type="audio/mpeg">
...
function checkLogin(){
  ...
  if(name==="drakon"){
    ...
    document.getElementById("bgMusic").play().catch(()=>{console.log("User interaction needed to play music")});
  } else {
